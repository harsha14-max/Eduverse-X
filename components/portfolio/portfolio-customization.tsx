      ...
      <CardContent className="space-y-6">
        ...
        <div className="p-4 rounded-lg bg-primary/5 border border-primary/20">
          ...
          <div className="text-xs text-muted-foreground mb-3">
            Connect your custom domain (e.g., portfolio.yourname.com) to showcase your portfolio professionally
          </div>
          <div className="space-y-3">
            <div>
            ...
            <div className="text-xs text-muted-foreground space-y-1">
              <div>• Requires DNS configuration</div>
              <div>• SSL certificate auto-provisioned</div>
              <div>• Subdomain forwarding supported</div>
            </div>
          </div>
        </div>
      </CardContent>
