      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="flex items-center justify-center gap-4 mb-8">
          ...
          <div className={`w-16 h-0.5 ${
            currentStep === "signup" ? "bg-primary" : "bg-border"
          } transition-colors`} />
          <div className={`w-12 h-12 rounded-full flex items-center justify-center border-2 transition-colors ${
            currentStep === "signup" 
              ? "border-primary bg-primary text-primary-foreground" 
            ...
            <Card className="border-border shadow-lg">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-lg">
                  Join EDUVERSE X as a {selectedIdentity === "student" ? "Student" : "Educator"}
                </CardDescription>
              </CardHeader>
              <CardContent className="p-8">
                <AuthOptions mode="signup" identityType={selectedIdentity} />
              </CardContent>
            </Card>
          </motion.div>
        )}
        ...
        <div className="text-center mt-8 text-sm text-muted-foreground">
          ...
          <p className="mt-2">
            Or continue as{" "}
            <Link href="/dashboard?mode=guest" className="text-primary hover:underline font-medium">
              Guest
            </Link>
          </p>
        </div>
